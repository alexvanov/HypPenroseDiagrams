...
for r1 in list_radius_out:
    ...
    plt.plot(R_out[valid_T],T_out[valid_T],'g--', linewidth=1.3)
...
for t1 in list_time_out:
    ...
    plt.plot(R_out,T_out,'g-', linewidth=1.3)
...
file_path = os.path.join('C:\\Users\\jacma\\OneDrive - Universidade de Lisboa\\Desktop\\PIC\\Report\\Images', 'Schwarzschild.pdf')
