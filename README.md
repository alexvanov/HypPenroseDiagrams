...
* Python scripts to create the diagrams for Schwarzschild (python\_scripts\_Schwarzschild), kindly provided by André Matias [joao.c.matias@tecnico.ulisboa.pt](mailto:joao.c.matias@tecnico.ulisboa.pt).
* Python scripts to create the diagrams for Reissner-Nordström (python\_scripts\_RN), kindly provided by Adrián Devesa García adriandevesa007@gmail.com.
